                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                    ...
                                    @foreach($data as $rs)
                                        <tr>
                                          ...
                                          <span
                                                ...
                                                <a href="{{route('admin.image.index',['pid'=>$rs->id])}}"
                                                   ...
                                                   data-toggle="tooltip">
                                                    <img class="avatar avatar-sm me-3"
                                                         src="{{asset('assets')}}/img/carousel-1.jpg" alt="Image">
                                                </a>
                                            </td>
                                            <td class="align-middle">
                                                <a href="{{route('admin.service.destroy',['id'=>$rs->id])}}"
                                            ...
                                            <td class="align-middle">
                                                <a href="{{route('admin.service.edit',['id'=>$rs->id])}}"
                                            ...
                                            <td class="align-middle">
                                                <a href="{{route('admin.service.show',['id'=>$rs->id])}}"
                                ...
                                <a href="{{route('admin.service.create')}}" style="text-decoration: none;color: white">
